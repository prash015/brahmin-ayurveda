...
const Hospitals = () => {
  ...
  const facilities = [
    { title: 'Panchkarma Theatre', icon: 'bi-droplet-half', img: PanchkarmaTheatre, desc: 'Hygienic, traditional therapy rooms with steam baths.' },
    ...
    { title: 'Yoga & Meditation Hall', icon: 'bi-sun', img: YogaHall, desc: 'Peaceful space for morning Yoga and Pranayama.' },
